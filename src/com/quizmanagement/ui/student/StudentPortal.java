...
public class StudentPortal extends javax.swing.JFrame {
    private static final Logger logger = LoggerFactory.getLogger(StudentPortal.class);
    ...
    public StudentPortal(String username) {
        ...
        setTitle("Quiz Management System - Student");
    ...
    private void initUI() {
        ...
        mainTabbedPane.addChangeListener(e -> handleTabChange());
        
        dashboard = new Dashboard(user, mainTabbedPane);
        statisticsPanel = new StatisticsPanel(user, mainTabbedPane);
        
        mainTabbedPane.addTab("  Dashboard  ", dashboard);
    ...
    private JPanel createHeader() {
        ...
        JPanel userBadge = styles.UserBadge.create(username, "Student", HIGHLIGHT);
    ...
    private void handleTabChange() {
        try {
            ...
            if (lastActiveTabIndex == selectedIndex) return;

            if (lastActiveTabIndex >= 0 && lastActiveTabIndex < mainTabbedPane.getTabCount()) {
                Component lastComponent = mainTabbedPane.getComponentAt(lastActiveTabIndex);
                if (lastComponent instanceof AttemptQuizPanel) {
                    int response = JOptionPane.showConfirmDialog(
                        this,
                        "Switching tabs will discard your current quiz progress.\nAre you sure?",
                        "Discard Quiz?",
                    ...
                    if (response != JOptionPane.YES_OPTION) {
                        mainTabbedPane.setSelectedIndex(lastActiveTabIndex);
                        return;
                    } else {
                        AttemptQuizPanel attemptQuizPanel = (AttemptQuizPanel) lastComponent;
                        attemptQuizPanel.discardQuizAttempt();
                        mainTabbedPane.remove(attemptQuizPanel);
            ...
            if (selectedComponent instanceof Dashboard) {
                dashboard.refreshDashboard();
            }

            lastActiveTabIndex = selectedIndex;
        } catch (Exception e) {
            logger.error("Error handling tab state change", e);
        }
    }
    ...
    private void initComponents() {
        ...
        headerText.setText("Student QMS - ");
        ...
        MainViewPane.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                MainViewPaneStateChanged(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(minButton, javax.swing.GroupLayout.DEFAULT_SIZE, 19, Short.MAX_VALUE)
                            .addComponent(logout, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                            .addComponent(exitButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addComponent(MainViewPane, javax.swing.GroupLayout.PREFERRED_SIZE, 683, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(19, 19, 19))
        );
    ...
    private void MainViewPaneStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_MainViewPaneStateChanged
    }//GEN-LAST:event_MainViewPaneStateChanged
